...
from ._libs._tree import BestFirstTreeBuilder
from ._libs._tree import Tree
from ._libs._tree import _build_pruned_tree_ccp
from ._libs._tree import ccp_pruning_path
...
class DecisionTreeRegressor(RegressorMixin, BaseDecisionTree):
    ...
    def classes_(self):
        ...
        msg = "the classes_ attribute is to be deprecated from version " "0.22 and will be removed in 0.24."
    ...
    def n_classes_(self):
        # TODO: Remove method in 0.24
        msg = "the n_classes_ attribute is to be deprecated from version " "0.22 and will be removed in 0.24."
        warnings.warn(msg, FutureWarning)
